			...
			<div class="form-group">
				...
				<div class="col-md-2">
					<input id="searchNomPrenom" name="searchNomPrenom" type="text"
						placeholder="nom ou prénom..." class="form-control input-md">
	...
	<div class="jumbotron row ">
		...
		<c:forEach var="collab" items="${ collaborateurs }">
			...
			<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
				...
				<ul>
					<li>Matricule : ${ collab.matricule }<br>
						Nom : ${ collab.nom }<br>
						Prenom : ${ collab.prenom }><br>
						Date de Naissance : ${ collab.dateDeNaissance }<br>
						Adresse : ${ collab.adresse }<br>
						Numero de séurité sociale :${ collab.numSecu }<br>
						Date de création : ${ collab.dateHeureCreation }<br>
						Email professionel : ${ collab.email }<br>
						actif ? : ${ collab.actif }<br>
						<br> <br>
					</li>
